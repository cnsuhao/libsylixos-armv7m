...
typedef float                       FP32;                               /*  32 位浮点数定义             */
typedef double                      FP64;                               /*  64 位浮点数定义             */

/*********************************************************************************************************
  堆栈类型定义, sizeof(STACK) 必须与 sizeof(void *) 相等, 也就是说每一个堆栈元素可以保存一个指针.
*********************************************************************************************************/

typedef unsigned int                STACK;                              /*  定义系统堆栈元素类型        */
typedef unsigned int               *PSTACK;                             /*  定义系统堆栈指针            */

/*********************************************************************************************************
  此类型变量用来保存系统开关中断的上下文.
*********************************************************************************************************/

typedef unsigned int                INTREG;                             /*  定义处理器中断寄存器        */
