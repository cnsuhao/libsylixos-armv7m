...
*********************************************************************************************************/
LW_API  
VOID  API_AtomicLock (INTREG  *piregInterLevel)
{
    __LW_ATOMIC_LOCK(*piregInterLevel);
}
/*********************************************************************************************************
** 函数名称: API_AtomicUnlock
** 功能描述: 解锁原子锁 (只为特定系统提供服务)
** 输　入  : iregInterLevel    中断寄存器上下文
** 输　出  : NONE
** 全局变量: 
** 调用模块: 
                                           API 函数
*********************************************************************************************************/
LW_API  
VOID  API_AtomicUnlock (INTREG  iregInterLevel)
{
