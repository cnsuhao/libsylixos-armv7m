...
static LW_INLINE  ULONG   __timevalToTick (const struct timeval  *ptv)
{
    ...
    ulTicks  = (ULONG)(ptv->tv_sec * LW_CFG_TICKS_PER_SEC);
    ulTicks += ((((ptv->tv_usec * LW_CFG_TICKS_PER_SEC) / 100) / 100) / 100);
...
static LW_INLINE  INT64   __timevalToTick64 (const struct timeval  *ptv)
{
    ...
    i64Ticks  = (INT64)(ptv->tv_sec * LW_CFG_TICKS_PER_SEC);
    i64Ticks += (((((INT64)ptv->tv_usec * LW_CFG_TICKS_PER_SEC) / 100) / 100) / 100);
...
static LW_INLINE  ULONG   __timespecToTick (const struct timespec  *ptv)
{
    ...
    ulTicks  = (ULONG)(ptv->tv_sec * LW_CFG_TICKS_PER_SEC);
    ulTicks += (((((ptv->tv_nsec / 1000) * LW_CFG_TICKS_PER_SEC) / 100) / 100) / 100);
...
static LW_INLINE  INT64   __timespecToTick64 (const struct timespec  *ptv)
{
    ...
    i64Ticks  = (INT64)(ptv->tv_sec * LW_CFG_TICKS_PER_SEC);
    i64Ticks += ((((((INT64)ptv->tv_nsec / 1000) * LW_CFG_TICKS_PER_SEC) / 100) / 100) / 100);
...
{
    ptv->tv_sec  = (time_t)(ulTicks / LW_CFG_TICKS_PER_SEC);
    ptv->tv_usec = (LONG)(ulTicks % LW_CFG_TICKS_PER_SEC) * ((100 * 100 * 100) / LW_CFG_TICKS_PER_SEC);
}

static LW_INLINE  VOID   __tick64ToTimeval (INT64  i64Ticks, struct timeval  *ptv)
{
    ptv->tv_sec  = (time_t)(i64Ticks / LW_CFG_TICKS_PER_SEC);
    ptv->tv_usec = (LONG)(i64Ticks % LW_CFG_TICKS_PER_SEC) * ((100 * 100 * 100) / LW_CFG_TICKS_PER_SEC);
}

static LW_INLINE  VOID   __tickToTimespec (ULONG  ulTicks, struct timespec  *ptv)
{
    ptv->tv_sec  = (time_t)(ulTicks / LW_CFG_TICKS_PER_SEC);
    ptv->tv_nsec = (LONG)(ulTicks % LW_CFG_TICKS_PER_SEC) * ((1000 * 1000 * 1000) / LW_CFG_TICKS_PER_SEC);
}

static LW_INLINE  VOID   __tick64ToTimespec (INT64  i64Ticks, struct timespec  *ptv)
{
    ptv->tv_sec  = (time_t)(i64Ticks / LW_CFG_TICKS_PER_SEC);
    ptv->tv_nsec = (LONG)(i64Ticks % LW_CFG_TICKS_PER_SEC) * ((1000 * 1000 * 1000) / LW_CFG_TICKS_PER_SEC);
}
