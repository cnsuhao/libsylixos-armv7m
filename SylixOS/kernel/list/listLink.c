...
** 功能描述: 从前方向 RING 头中插入一个元素 (Header 将指向这个元素, 等待表的操作)
** 输　入  : 
** 输　出  : 
** 全局变量: 
** 调用模块: 
...
VOID  _List_Ring_Add_Ahead (PLW_LIST_RING  pringNew, LW_LIST_RING_HEADER  *ppringHeader)
{
    ...
    if (pringHeader) {                                                  /*  链表内还有元素              */
        ...
        pringNew->RING_plistPrev = pringNew;                            /*  只有新元素                  */
        pringNew->RING_plistNext = pringNew;                            /*  自我抱环                    */
    }
    
    *ppringHeader = pringNew;                                           /*  将表头指向新元素            */
}
/*********************************************************************************************************
** 函数名称: _List_Ring_Add_Front
** 功能描述: 从前方向 RING 头中插入一个元素 (Header 有元素时，不变化，就绪表的操作)
** 输　入  : 
** 输　出  : 
** 全局变量: 
** 调用模块: 
...
VOID  _List_Ring_Add_Front (PLW_LIST_RING  pringNew, LW_LIST_RING_HEADER  *ppringHeader)
{
    ...
    if (pringHeader) {                                                  /*  链表内还有元素              */
        ...
        pringNew->RING_plistPrev = pringNew;                            /*  只有新元素                  */
        pringNew->RING_plistNext = pringNew;                            /*  自我抱环                    */
        *ppringHeader = pringNew;                                       /*  更新了了链表头              */
    }
}
/*********************************************************************************************************
** 函数名称: _List_Ring_Add_Last
** 功能描述: 从后方向 RING 尾中插入一个元素
** 输　入  : 
** 输　出  : 
** 全局变量: 
** 调用模块: 
...
VOID  _List_Ring_Del (PLW_LIST_RING  pringDel, LW_LIST_RING_HEADER  *ppringHeader)
{
    ...
    if (pringDel->RING_plistNext == pringDel) {                         /*  链表中只有一个元素          */
...
** 功能描述: 从前方向 Line 头中插入一个元素 (Header 将指向这个元素)
** 输　入  : 
** 输　出  : 
** 全局变量: 
** 调用模块: 
...
** 功能描述: 从尾部 Line 插入一个元素 (Header 不变)
** 输　入  : 
** 输　出  : 
** 全局变量: 
** 调用模块: 
